document.addEventListener('DOMContentLoaded', function () {
   ...
   // Stop event propagation when clicking on inner anchors
   document.querySelectorAll('.dropdown ul a').forEach((anchor) => {
   ...
   window.addEventListener('scroll', function () {
      ...
      if (currentScroll > lastScrollTop) {
         ...
         document.querySelector('header nav').style.backgroundColor = 'var(--main-color)';
      } else {
         // Scrolling up
         ...
         if (currentScroll <= 0) {
            document.querySelector('header nav').style.backgroundColor = '#ffffff2e';
         }
      }
   ...
   window.addEventListener('scroll', function () {
      ...
      if (currentScroll > 50) {
         if (!isPast200px) {
            ...
            document.querySelector('header').style.backgroundImage = 'var(--color-gradient)'; // Change to the desired color
            isPast200px = true;
         }
      } else {
         // Scrolled within the first 200px
         if (isPast200px) {
            document.querySelector('header').style.backgroundImage = 'none'; // Change to the desired color
            isPast200px = false;
